...
var canvas, ctx, diagram, distBetween, draw, drawGrid, drawnLayers, hovered, index, mouse, options_ui, place, run, run_indicator, running, saved_state, select, selected, selectedShape, setShape, shapeAt, stop, toolbar, ui, ui_root, views,
...
drawGrid = function() {
  var gridSize, x, y, _i, _j, _ref, _ref1;
  gridSize = 40;
  ctx.beginPath();
...
ui.dragging = {
  ...
  mousemove: function(e) {
    ...
    this.dragPos = mouse;
    if (typeof (_base = this.object).moveBy === "function") {
      _base.moveBy(delta);
    }
    if (typeof (_base1 = this.object).moveTo === "function") {
      _base1.moveTo(mouse);
    }
    return draw();
  },
